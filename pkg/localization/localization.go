...
func GetText(key string) string {
	var data = texts[key]
	if data != nil {
		if vars.Language == "it-IT" {
			return data[1]
		} else if vars.Language == "es-ES" {
			return data[2]
		} else if vars.Language == "fr-FR" {
			return data[3]
		} else if vars.Language == "de-DE" {
			return data[4]
		} else if vars.Language == "pl-PL" {
			return data[5]
		} else if vars.Language == "zh-CN" {
			return data[6]
		} else if vars.Language == "tr-TR" {
			return data[7]
		} else if vars.Language == "ru-RU" {
			return data[8]
		}
	}
	return data[0]
